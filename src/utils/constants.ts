...
export const SITE_CONSTANTS = Object.freeze({
    DEFAULT_MAX_POSTS_PER_PAGE:  Math.max(1, process.env.NEXT_PUBLIC_DEFAULT_MAX_POSTS_PER_PAGE as number),
    DEFAULT_PAGINATION_MAX_LINKS: Math.max(5, process.env.NEXT_PUBLIC_DEFAULT_PAGINATION_MAX_LINKS as number),
})